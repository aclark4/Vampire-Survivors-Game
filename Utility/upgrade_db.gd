...
const UPGRADES = { # Directory of Upgrades
	"icespear1": {
	...
	"icespear2": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Ice Spear",
		"details": "Ice Spears can now pass through up to 2 enemies, and do 8 damage",
		"level": "Level: 2",
	...
	"icespear4": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Ice Spear",
		"details": "Ice Spears move much faster, and reload Quicker",
		"level": "Level: 4",
	...
	"icespear5": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Ice Spear",
		"details": "Ice Spears are larger, and do 12 damage!",
		"level": "Level: 5",
	...
	"icespear6": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Ice Spear",
		"details": "An additional 2 Ice Spears are thrown, and Ice Spears have stronger Knockback!",
		"level": "Level: 5",
